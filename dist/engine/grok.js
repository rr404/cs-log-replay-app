...
export class GrokEngine {
    ...
    buildRegex(expr) {
        const pattern = this.expandWithCaptures(expr);
        try {
     ...
     */
    expandWithCaptures(expr, depth = 0) {
        if (depth > 20)
